...
def setup_database():
    ...
    ('CH001', 'EMP002', NULL, '2025-10-01 10:15:00', 201.50, 40.30),
    ('CH002', 'EMP003', 'CARD001', '2025-10-01 11:30:00', 142.50, 28.50),
    ('CH003', 'EMP004', 'CARD002', '2025-10-01 14:45:00', 485.00, 97.00),
    ('CH004', 'EMP005', 'CARD003', '2025-10-02 09:20:00', 90.00, 18.00),
    ('CH005', 'EMP002', 'CARD004', '2025-10-02 16:10:00', 1025.00, 205.00),
    ('CH006', 'EMP005', NULL, '2025-10-03 12:05:00', 340.00, 68.00),
    ('CH007', 'EMP004', 'CARD005', '2025-10-03 18:30:00', 76.00, 15.20),
    ('CH008', 'EMP002', 'CARD001', '2025-10-04 08:50:00', 452.50, 90.50),
    ('CH009', 'EMP002', NULL, '2025-10-05 09:15:00', 192.50, 38.50),
    ('CH010', 'EMP002', 'CARD002', '2025-10-05 11:45:00', 295.20, 59.04),
    ('CH011', 'EMP002', NULL, '2025-10-06 14:20:00', 230.00, 46.00),
    ('CH012', 'EMP002', 'CARD005', '2025-10-06 18:00:00', 378.00, 75.60),
    ('CH013', 'EMP003', 'CARD001', '2025-10-05 10:30:00', 57.00, 11.40),
    ('CH014', 'EMP004', NULL, '2025-10-05 16:15:00', 150.00, 30.00),
    ('CH015', 'EMP002', 'CARD003', '2025-10-06 09:05:00', 258.40, 51.68),
    ('CH016', 'EMP004', NULL, '2025-10-06 19:30:00', 200.00, 40.00),
    ('CH017', 'EMP005', NULL, '2025-10-07 08:10:00', 200.00, 40.00),
    ('CH018', 'EMP002', 'CARD002', '2025-10-08 12:00:00', 426.60, 85.32),
    ('CH019', 'EMP003', 'CARD003', '2025-10-08 14:30:00', 286.45, 57.29),
    ('CH020', 'EMP002', 'CARD001', '2025-10-09 10:00:00', 285.00, 57.00);
    """)
    ...
    -- Демо-чек CH020: CARD001 купує в категоріях 3, 4, 5 → разом із CH002/CH013 (кат. 1, 2)
    -- клієнт CARD001 має покупки в усіх 5 категоріях (для звіту «купували в усіх категоріях»)
    ('UPC006', 'CH020', 1, 150.00),
    ('UPC009', 'CH020', 1, 55.00),
    ('UPC011', 'CH020', 1, 80.00);
    """)
